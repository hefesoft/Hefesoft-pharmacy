...
public class Ciclos extends FragmentActivity implements ActionBar.TabListener {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if(item.getItemId() == android.R.id.home){
			...
			SlideoutActivity.prepare(Ciclos.this, R.id.Medicos_Contenedor, width);
			startActivity(new Intent(Ciclos.this, MenuParametrizacion.class));
